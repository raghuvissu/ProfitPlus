(function (module) {
    mifosX.services = _.extend(module, {
        ...
        UIConfigService: function ($q,$http,$templateCache, webStorage) {
            ...
            this.init  = function() {
                ...
                $http.get('scripts/config/UIconfig.json').success(function(data) {
                    ...
                    webStorage.add("uiConfigData",data);
                }).error(function(data) {
    ...
    mifosX.ng.services.service('UIConfigService', ['$q','$http','$templateCache', 'webStorage',mifosX.services.UIConfigService]).run(function ($log) {
