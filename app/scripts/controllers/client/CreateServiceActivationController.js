(function(module) {
  mifosX.controllers = _.extend(module, {
	  CreateServiceActivationController: function(scope,webStorage,routeParams, resourceFactory, location, http,filter,PermissionService, dateFilter,$rootScope,API_VERSION) {
		       ...
		       scope.submit = function(){
		    	   ...
		    	   for(var i in scope.plandatas){
		    		   if(scope.plandatas[i].id == scope.formData.planCode){
		    			   scope.planName = scope.plandatas[i].planCode;
		    			   scope.planPoId = scope.plandatas[i].planPoId;
		    			   break;
		    		   }
		    	   }
...
mifosX.ng.application.controller('CreateServiceActivationController', [
                                                                  '$scope',
                                                                  'webStorage',
                                                                  '$routeParams',
                                                                  'ResourceFactory', 
                                                                  ...
                                                                  '$rootScope',
                                                                  'API_VERSION',
                                                                  mifosX.controllers.CreateServiceActivationController]).run(function($log) {
    $log.info("CreateServiceActivationController initialized");
  });
}(mifosX.controllers || {}));